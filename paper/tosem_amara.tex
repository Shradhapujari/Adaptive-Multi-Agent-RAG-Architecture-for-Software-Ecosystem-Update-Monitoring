...
omitted from the paired rows for the reason given in the text.}
\label{tab:clean}
...
to~\ref{sec:leak} establish, that is stated at the point it appears
...
and its scaled counterpart (13 of 172) was computed on 100 questions. What the
census counted is the subject of Section~\ref{sec:leak}.
