...
A4 & \texttt{marag\_llm\_retry} & Orchestrator retry & Cannot trigger \\
...
independently of each other. We report the rung as unmeasurable in the
configuration released here, and leave both changes to future work rather than
tune a threshold until an arm produces a difference.
