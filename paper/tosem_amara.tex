...
against a snapshot recorded in a preceding pass; 24{,}455 entries, and the
replay records its own misses, so the corpus is fixed for the arms within the
run but the run is not frozen). It is the same answer: nDCG@3 0.485 for both
