...
- Systems: marag, single_agent, raw:ollama:llama3.1, raw:ollama:mistral
- Seed: 42  |  top_k: 4
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| marag | 0.433±0.272 | 0.167±0.201 | 0.158±0.199 | 0.193±0.186 | 0.275±0.195 | 0.201±0.185 | 0.308±0.209 | 0.660±0.080 | 0.950±0.098 | 0.537±0.152 | 0.535 | 13.83 |
...
| Category | marag | single_agent | raw:ollama:llama3.1 | raw:ollama:mistral |
|---|---|---|---|---|
